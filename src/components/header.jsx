...
<div>
 ...
 <div className="navbar-start">
    ...
    <div className="dropdown">
     ...
     <li><Link to="/register" className=" bg-indigo-500 mt-5 mb-3 mx-10 hover:bg-indigo-700 text-xl">Register</Link></li>
    <li><button onClick={handleSignOut} className="bg-violet-600  hover:bg-violet-800 text-xl mx-10">Sign Out</button></li>
  ...
  <div className="navbar-center hidden lg:flex ml-72">
    <ul className='menu menu-horizontal p-0 '>
     ...
     <li><Link to="/faq" className="btn btn-ghost normal-case text-xl">FAQ</Link></li>
     <li><Link to="/blog" className="btn btn-ghost normal-case text-xl">Blog</Link></li>
     <li><Link to="/register" className=" bg-indigo-500  hover:bg-indigo-700 text-xl ml-3">Register</Link></li>
     <li><button onClick={handleSignOut} className="bg-violet-600  hover:bg-violet-800 text-xl ml-3">Sign Out</button></li>
  
    </ul>
  </div>
<label className="swap swap-rotate ml-40 ">
